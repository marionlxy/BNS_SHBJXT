...
@var callback = callback!""; //树初始化后回调函数
...
<div class="clearfix ${class} input-group" style="${style}">
	...
	<span class="input-group-btn">
		<span class="btn btn-purple btn-sm" type="button"
	...
	<script>
		$.ajax({
			...
			data:{url:'${url}',id:'${id}',nameId:'${nameId}',pIdKey:'${pIdKey}',
				...
				treeSelectId:'${treeSelectId}',rootNodeName:'${rootNodeName}',chkboxType:'${chkboxType}',callback:'${callback}'},
