...
for(m=0;m<test.length;m++){
	var test2=test[m].id.indexOf("dataTable");
	if(test2 != "-1"){
		//alert(test[m].id);


var trl=document.getElementById(test[m].id).getElementsByTagName("tr");
...
//处理托拽
var thl=document.getElementById(test[m].id).getElementsByTagName("th");
