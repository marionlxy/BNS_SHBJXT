...
(function() {
        ...
        return {
            ...
            on: function(b, d, g, l, k) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    n.fn = d;
                    n.priority = k;
                    for (var A = f.length - 1; 0 <= A; A--) if (f[A].priority <= k) return f.splice(A + 1, 0, n),
                    {
                        removeListener: w
                    };
                    f.unshift(n)
                ...
                return function(k, n, w) {
                    ...
                    if (f) {
                        ...
                        if (A.length) for (var A = A.slice(0), u, B = 0; B < A.length; B++) {
                            if (f.errorProof) try {
                                u = A[B].call(this, w, n, b, l)
                            } catch(q) {} else u = A[B].call(this, w, n, b, l); ! 1 === u ? g = 1 : "undefined" != typeof u && (n = u);
                            if (a || g) break
                        }
                    }
    ...
    CKEDITOR.dom = {}; (function() {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                c = c.replace(/\n/g, "\x3cbr\x3e");
                b || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + k + "\x3e)"),
                function(a) {
            ...
            enableHtml5Elements: function(a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), k = c.length, d; k--;) d = a.createElement(c[k]),
                b && a.appendChild(d)
            },
            checkIfAnyArrayItemMatches: function(a, b) {
                for (var c = 0,
                k = a.length; c < k; ++c) if (a[c].match(b)) return ! 0;
                return ! 1
            },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function(a) {
            function d(a, c) {
                ...
                return n && n.nodeType == CKEDITOR.NODE_TEXT ? b(n) ? d(n, c) : n: null
            }
            function b(a) {
    ...
    CKEDITOR.dom.element.clearMarkers = function(a, d, b) {
        ...
        function c(a) {
            for (var b = 0,
            c = 0,
            f = l[a].length; c < f; c++) b += parseInt(this.getComputedStyle(l[a][c]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    ...
                    for (; y && !y.equals(q);) b -= y.$.scrollLeft,
                    c -= y.$.scrollTop,
                    y = y.getParent();
                    y = q;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                d = d.y + z + y(this, "bottom") - (t.y + h) || 0; (0 > u || 0 < d) && g(0, !0 === b ? u: !1 === b ? d: 0 > u ? u: d);
            ...
            copyAttributes: function(a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    ...
                    else if (!CKEDITOR.env.ie || this.hasAttribute(e)) u = this.getAttribute(e),
                    null === u && (u = d.nodeValue),
                    a.setAttribute(e, u)
                }
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            this.current ? f = this.current[m](!1, p, z) : (a ? f.type == CKEDITOR.NODE_ELEMENT && (f = 0 < x ? f.getChild(x - 1) : !1 === z(f, !0) ? null: f.getPreviousSourceNode(!0, p, z)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === z(d, !0) ? null: d.getNextSourceNode(!0, p, z)))), f && !1 === z(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        CKEDITOR.dom.walker.empty = function(a) {
            return function(b) {
                for (var c = 0,
                f = b.getChildCount(); c < f; ++c) if (!w(b.getChild(c))) return !! a;
                return ! a
            }
        };
        ...
        CKEDITOR.dom.walker.editable = function(a) {
            return function(b) {
                b = w(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && f(b)) ? !0 : !1;
                return !! (a ^ b)
            }
        };
    ...
    CKEDITOR.dom.range = function(a) {
        ...
        function d(a, b, c, d, e) {
            ...
            function l() {
                var b = I - 1,
                c = w && n && !p.equals(m);
                b < E - 1 || b < L - 1 || c ? (c ? a.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START) : L == b + 1 && H ? a.moveToPosition(D[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(D[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = v[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
                    startNode: c
                }))) : a.collapse(!0)
            }
            a.optimizeBookmark();
            ...
            r = a.endOffset,
            G, H, w, n, M, Q;
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(C, r)),
            c.append(p);
            else {
                ...
                J = c;
                for (O = I; O <= L; O++) if (c = D[O], V = c.getPrevious(), c.equals(v[O])) b && (J = J.getChild(0));
                else {
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ? "getPreviousNode": "getNextNode"](function(a) { ! b && w(a) && (b = a);
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function(a) {
                ...
                q || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(), e.collapse(), e.insertNode(c));
                e = this.clone();
                e.collapse(!0);
                e.insertNode(b);
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    for (h = c(h); h || p;) {
                        ...
                        for (; p;) if (r = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                            ...
                            if (p.type == CKEDITOR.NODE_TEXT) G = p.getText(),
                            d.test(G) && (p = null),
                            r = /[\s\ufeff]$/.test(G);
                            else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark")) if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                G = p.getText();
                                if (d.test(G)) p = null;
                                else for (var H = p.$.getElementsByTagName("*"), w = 0, n; n = H[w++];) if (!CKEDITOR.dtd.$removeEmpty[n.nodeName.toLowerCase()]) {
                                    p = null;
                                    break
                                }
                                p && (r = !!G.length)
                        ...
                        for (; p;) {
                            ...
                            r = /^[\s\ufeff]/.test(G);
                                ...
                                if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark")) if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    G = p.getText();
                                    if (d.test(G)) p = null;
                                    else for (H = p.$.getElementsByTagName("*"), w = 0; n = H[w++];) if (!CKEDITOR.dtd.$removeEmpty[n.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (r = !!G.length)
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var M, Q, v = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                        br: 1
                    }: null),
                    D = null,
                    I = function(a) {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    q && q.type == CKEDITOR.NODE_TEXT && (l ? l >= q.getLength() ? d.setEndAfter(q) : (d.setEndAfter(q), z = 0) : d.setEndBefore(q));
            ...
            splitBlock: function(a, b) {
                ...
                this.deleteContents();
                e && e.equals(q) && (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(q, CKEDITOR.POSITION_AFTER_END), q = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (q = this.splitElement(e, b || !1), e.is("ul", "ol") || e.appendBogus()));
                return {
                    previousBlock: e,
                    nextBlock: q,
                    wasStartOfBlock: c,
    ...
    "use strict"; (function() {
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; y;) {
                    ...
                    if (z) y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (z = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) {
                            ...
                            b(this, a, d);
                            break
                        } else if (y.isBlockBoundary(this.forceBrBreak && !t && {
                            br: 1
                        })) {
                            if ("br" == p) z = 1;
                            else if (!l && !y.getChildCount() && "hr" != p) {
                                d = y;
                                A = y.equals(q);
                                break
                            }
                ...
                if (!d) {
                    if (!l) return this._.docEndMarker && this._.docEndMarker.remove(),
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                else for (k in m = h.elements, delete h.elements, m) if (b[k]) b[k][p ? "unshift": "push"](h);
                else b[k] = [h]
            }
        }
        function d(a, c, d, h) {
        ...
        function l(a, b) {
            if (!a) return ! 1;
            if (!0 === a) return a;
            if ("string" == typeof a) return a = R(a),
        ...
        function f(a) {
            var b, c, d, h, p = {},
            e = 1;
            for (a = R(a); b = a.match(D);)(c = b[2]) ? (d = x(c, "styles"), h = x(c, "attrs"), c = x(c, "classes")) : d = h = c = null,
            p["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
        ...
        function u(a, b, h, e) {
            ...
            if (e.doFilter) {
                ...
                v && (m = 1);
                if (!e.skipFinalValidation && !y(b)) return h.push(b),
                1
            }
        ...
        function h(a, b, c) {
            ...
            else if (H.$block[d] || "tr" == d) if ("br" == b) a.previous && !z(a.previous) && (b = t(), b.insertBefore(a)),
            a.next && !z(a.next) && (b = t(), b.insertAfter(a)),
            a.replaceWithChildren();
                ...
                c.push({
                    ...
                    r, g, e = d.length; 0 < e;) m = d[--e],
                    p && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && H.$inline[m.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
                        check: "parent-down",
                        el: r
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                a = this.editor = a;
                this.customConfig = !0;
                var b = a.config.allowedContent; ! 0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(M[a.enterMode] + " " + M[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b) b = f(b);
                    ...
                    d && (d = K(d), h.classes = d["class"] ? d["class"].split(/\s+/) : null, h.requiredClasses = h.classes, delete d["class"], h.attributes = d, h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (r = u(p, a, e, f), r & 1) g = !0;
            ...
            addTransformations: function(a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        "string" == typeof m ? (m = m.split(/\s*:\s*/), g = m[0], q = null, f = m[1]) : (g = m.check, q = m.left, f = m.right),
                        p || (p = m, p = p.element ? p.element: g ? g.match(/^([a-z0-9]+)/i)[0] : p.left.getDefinition().element),
                        q instanceof CKEDITOR.style && (q = r(q)),
                        c.push({
                            check: g == p ? null: g,
                            left: q,
            ...
            check: function(a, b, c) {
                ...
                h = d.styles,
                m = d.attributes || {},
                h ? (h = K(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {},
                h = {
                    name: d.element,
                    attributes: m,
                ...
                if (!1 !== b && (g = this._.transformations[h.name])) {
                    for (d = 0; d < g.length; ++d) p(this, h, g[d]);
                    q(h)
                }
                u(this, m, r, {
                    doFilter: !0,
        ...
        J = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    r;
                    a.name = c.element;
                    for (p in h) if ("class" == p) for (c = a.classes.join("|"), e = h[p].split(/\s+/); r = e.pop();) - 1 == c.indexOf(r) && a.classes.push(r);
        ...
        return {
            load: function(b, c, e, g) {
                ...
                if (0 === k) f(!0);
                    ...
                    var x = function(a, b) { (b ? n: w).push(a);
                        ...
                        if (a[b]) x(b, !0);
                            ...
                            if (! (1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? g.$.onreadystatechange = function() {
                                    if ("loaded" == g.$.readyState || "complete" == g.$.readyState) g.$.onreadystatechange = null,
                                    A(b, !0)
                                }: (g.$.onload = function() {
                                    setTimeout(function() {
                                        A(b, !0)
            ...
            l = function(b) {
                ...
                function(a) {
                    ...
                    if (b.length) l.call(this, b);
                        ...
                        for (f in g) k = g[f],
                        k.onLoad && !k.onLoad._called && (!1 === k.onLoad() && delete g[f], k.onLoad._called = 1);
                        c && c.call(e || window, g)
                    }
                },
                this)
                ...
                l; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (l) l.push(c[0]);
                        ...
                        if (e = e.toLowerCase(), !/="/.test(e)) {
                            ...
                            this.onTagOpen(e, k, c); ! l && CKEDITOR.dtd.$cdata[e] && (l = [])
                        }
    ...
    CKEDITOR.htmlParser.fragment = function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(g, l, k) {
            ...
            B.onTagOpen = function(e, m, g, f) {
                ...
                if (a(m)) y.push(m);
                    ...
                    if ("br" == e) F.push(m);
                        ...
                        for (; ! (f = (g = t.name) ? CKEDITOR.dtd[g] || (t._.isBlockLike ? CKEDITOR.dtd.div: CKEDITOR.dtd.span) : c, m.isUnknown || t.isUnknown || f[e]);) if (t.isOptionalClose) B.onTagClose(g);
                        else if (e in b && g in b) g = t.children,
                        (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), t),
                        !m.returnPoint && (m.returnPoint = t),
                        t = g;
                        else if (e in CKEDITOR.dtd.$listItem && !u(e, g)) B.onTagOpen("li" == e ? "ul": "dl", {},
                        0, 1);
                        else if (g in d && !u(e, g)) ! m.returnPoint && (m.returnPoint = t),
                        t = t.parent;
            ...
            B.onTagClose = function(a) {
                ...
                for (var c = [], d = [], h = t; h != q && h.name != a;) h._.isBlockLike || d.unshift(h),
                c.push(h),
            ...
            B.onText = function(a) {
                ...
                B.onText(a);
                    ...
                    if (A(t, a)) this.onTagOpen(k, {},
                    0, 1);
                    t.add(a)
                }
            };
            B.onCDATA = function(a) {
    ...
    "use strict"; (function() {
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                ...
                f,
                x;
                for (x = 0; x < k; x++) if (d && (n = c.type, w = c.name), f = l[x], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
        ...
        function a(a, d) {
            ...
            function p(a, d) {
                return function(h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        r,
                        v;
                        if (p) for (f(p, 1) && e.push(p); p;) g(p) && (r = c(p)) && f(r) && ((v = c(r)) && !g(v) ? e.push(r) : (m(z).insertAfter(r), r.remove())),
                        p = p.previous;
                        for (p = 0; p < e.length; p++) e[p].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(h) : d)) z || CKEDITOR.env.needsBrFiller || h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? z || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h), e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1;
                        e && h.add(m(a))
                    }
                }
            }
            function f(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in v) || !z && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }
            var r = {
                elements: {}
            },
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
                            ...
                            var h = c(b); ! d && g(b.parent) ? l(b.parent, m(a)) : g(d) && h && !g(h) && m(a).insertBefore(d)
                        }
                    }
                }
            } (z);
        ...
        function q(a, b) {
            ...
            for (var p = 0; p < d.length; p++) a = a.replace(d[p],
            function(a) {
                a = a.replace(e,
                function(a, b, d) {
                    return c[d]
            ...
            a = a.replace(e,
            function(a, b, d) {
                return "\x3c!--" + F + (b ? "{C}": "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
            });
    ...
    CKEDITOR.htmlParser.cssStyle = function(a) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) {
                    l = d.name;
                    if (! (k = a.onElementName(b, l))) return this.remove(),
                    !1;
                    d.name = k;
                ...
                var n, w;
                for (n in l) {
                    for (k = l[n];;) if (w = a.onAttributeName(b, n)) if (w != n) delete l[n],
                    n = w;
                    else break;
                    else {
                        delete l[n];
    ...
    CKEDITOR.replaceClass = "ckeditor"; (function() {
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && l && l[a]) {
                ...
                if (d.mode) {
                    ...
                    "source" == d.mode && l == n && (d.fire("lockSnapshot", {
                        forceUpdate: !0
                    }), w = 1);
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, l) {
            ...
            l.setSize("width", a, !0);
            w && (w.style.width = "1%");
            var f = (l.$.offsetHeight || 0) - (n.$.clientHeight || 0),
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        function a(a) {
            ...
            !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = r.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), g = 1, a.cancel());
            g && r.select()
        }
        function d(a, b) {
        ...
        function g(a) {
            ...
            if (e.startPath().contains(f)) {
                ...
                a.guard = b();
                a.checkBackward();
                if (d) return r = e.clone(),
                r.collapse(),
                r.setEndAt(d, CKEDITOR.POSITION_AFTER_END),
                a = new CKEDITOR.dom.walker(r),
                a.guard = b(!0),
                d = !1,
                a.checkForward(),
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, l;
                    if (f) for (; (g = b.getCommonAncestor(0, 1)) && (l = CKEDITOR.dtd[g.getName()]) && (!l || !l[e]);) g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div": "p", c.editable());
                    b.insertNode(a);
                    return ! 0
                },
                ...
                setup: function() {
                    ...
                    function() {
                        var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(B,
                        function(a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    ...
                    if (!this.is("textarea")) {
                        ...
                        function(b) {
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (h && d[c ? "checkStartOfBlock": "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) {
                                        ...
                                        if (!d || d && d.contains(h)) b = void 0;
                                            ...
                                            a.fire("saveSnapshot");
                                            var m; (m = (c ? d: h).getBogus()) && m.remove();
                                            m = a.getSelection();
                                            e = m.createBookmarks(); (c ? h: d).moveChildren(c ? d: h, !1);
                                ...
                                m = b.block,
                                d = c.endPath().block,
                                m && d && !m.equals(d) ? (a.fire("saveSnapshot"), (h = m.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(m, !1), b.lastElement.mergeSiblings(), w(m, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        q = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var l = q[l.getName()], r = 0, k = c.getChildren(), C = k.count(), G = -1, n = -1, w = 0, K = e.contains(q.$list); r < C; ++r) e = k.getItem(r),
                a(e) ? (f = e.getName(), K && f in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!l[f], "br" != f || !e.data("cke-eol") || r && r != C - 1 || (w = (m = r ? g[r - 1].node: k.getItem(r + 1)) && (!a(m) || !m.is("br")), m = m && a(m) && q.$block[m.getName()]), -1 != G || p || (G = r), p || (n = r), g.push({
                    isElement: 1,
                    isLineBreak: w,
                    ...
                    node: e,
                    allowed: 1
                }); - 1 < G && (g[G].firstNotAllowed = 1); - 1 < n && (g[n].lastNotAllowed = 1);
                return g
            }
            function d(b, c) {
                var e = [],
                ...
                for (r && e.push(" "); g < m; g++) f = h.getItem(g),
                a(f) && !f.is(l) ? e = e.concat(d(f, c)) : e.push(f);
                r && e.push(" ");
                return e
            }
            function e(b) {
            ...
            function g(b, c, d, e) {
                ...
                m,
                f;
                h.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (m = (new CKEDITOR.dom.walker(h)).next()) && a(m) && n[m.getName()] && (f = m.getPrevious()) && a(f) && !f.getParent().equals(b.startContainer) && d.contains(f) && e.contains(m) && m.isIdentical(f) && (m.moveChildren(f), m.remove(), g(b, c, d, e))
            }
            function G(b, c) {
                function d(b, c) {
            ...
            return function(n, v, D, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    K = v.startPath();
                    if (E = K.contains(f, !1, 1)) v.splitElement(E),
                    n.inlineStylesRoot = E,
                    n.inlineStylesPeak = K.lastElement;
                    K = v.createBookmark(); (E = K.startNode.getPrevious(c)) && a(E) && f(E) && I.push(E); (E = K.startNode.getNext(c)) && a(E) && f(E) && I.push(E);
                    ...
                    if (K = D) {
                        ...
                        if ("text" == n.type && n.inlineStylesRoot) {
                            ...
                            for (I = n.inlineStylesRoot.getParent(); ! u.equals(I);) v = v.appendTo(u.clone()),
                            u = u.getParent();
                    ...
                    if (K) {
                        ...
                        for (G(v, x); I < v.length; I++) {
                            ...
                            if (t) D = 0 < I;
                                ...
                                t = x.startPath(); ! J.isBlock && l(n.editor, t.block, t.blockLimit) && (T = k(n.editor)) && (T = K.createElement(T), T.appendBogus(), x.insertNode(T), CKEDITOR.env.needsBrFiller && (B = T.getBogus()) && B.remove(), x.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
                                if ((t = x.startPath().block) && !t.equals(N)) {
                                    if (B = t.getBogus()) B.remove(),
                                    A.push(t);
                                    N = t
                                }
                                ...
                                if (E && J.isElement) {
                                    ...
                                    if (t) F && (W = x.splitElement(F), n.zombies.push(W), n.zombies.push(F));
                                    else {
                                        F = u.getName();
                                        X = !I;
                                        t = I == v.length - 1;
                                        F = d(J.node, F);
                                        for (var S = [], aa = F.length, ca = 0, ea = void 0, Y = 0, U = -1; ca < aa; ca++) ea = F[ca],
                                        " " == ea ? (Y || X && !ca || (S.push(new CKEDITOR.dom.text(" ")), U = S.length), Y = 1) : (S.push(ea), Y = 0);
                                        t && U == S.length && S.pop();
                                        X = S
                                    }
                                }
                        ...
                        1 != v.length ? B = !1 : (B = v[0], B = B.isElement && "false" == B.node.getAttribute("contenteditable"));
        ...
        t = function() {
            ...
            function b(c, d, e) {
                a(d);
                a(e, 1);
                for (var h; h = e.getNext();) h.insertAfter(d),
                d = h;
                A(c) && c.remove()
            }
            function c(a, b) {
                ...
                table: function() {
                    function a(c) {
                        ...
                        f.guard = function(a, f) {
                            ...
                            if (f && g && a.equals(g)) h = c.clone(),
                            h.setEndAt(g, CKEDITOR.POSITION_BEFORE_END),
                            e.push(h);
                            else if (!f && m && a.equals(m)) h = c.clone(),
                            h.setStartAt(m, CKEDITOR.POSITION_AFTER_START),
                            e.push(h);
                            else {
                    ...
                    return {
                        detectPurge: function(a) {
                            ...
                            if (1 < e) {
                                ...
                                c && h && b.checkBoundaryOfElement(c, CKEDITOR.START) && b.checkBoundaryOfElement(h, CKEDITOR.END) && (b = a.range.clone(), b.setStartBefore(c), b.setEndAfter(h), a.purgeTableBookmark = b.createBookmark())
                            }
                        },
                        detectRanges: function(e, h) {
                            ...
                            v = v.contains("table");
                            k = k.contains("table");
                            if (v || k) v && k && b(v, k) ? (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), g = f.clone(), g.setEndAt(v, CKEDITOR.POSITION_AFTER_END), l = f.clone(), l.setStartAt(k, CKEDITOR.POSITION_BEFORE_START), l = a(g).concat(a(l))) : v ? k || (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), f.setEndAt(v, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START)),
                            e.tableContentsRanges = l ? l: a(f)
                        },
        ...
        function d() {
            A = !0;
            x || (b.call(this), x = CKEDITOR.tools.setTimeout(b, 200, this))
        }
        function b() {
            x = null;
        ...
        function(b) {
            ...
            function() {
                ...
                if (CKEDITOR.env.ie || n) q ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1),
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function() {
                return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel: this._.cache.nativeSel = q ? this.document.$.selection: this.document.getWindow().$.getSelection()
            },
            getType: q ?
            function() {
                var a = this._.cache;
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, g, h = b.duplicate(), l = 0, v = e.length - 1, k = -1, m, E; l <= v;) if (k = Math.floor((l + v) / 2), f = e[k], h.moveToElementText(f), m = h.compareEndPoints("StartToStart", b), 0 < m) v = k - 1;
                        else if (0 > m) l = k + 1;
                        else return {
                            container: d,
                            offset: a(f)
                        ...
                        if ( - 1 == k || k == e.length - 1 && 0 > m) {
                            ...
                            for (d = e.length; 0 < h && 0 < d;) g = e[--d],
                            g.nodeType == CKEDITOR.NODE_TEXT && (E = g, h -= g.nodeValue.length);
                            return {
                                container: E,
                                offset: -h
                            }
                        ...
                        for (; 0 < h;) try {
                            ...
                            g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, E = g),
                            f = g
                        } catch(n) {
                            return {
                                container: d,
                        ...
                        return {
                            container: E,
                            offset: 0 < m ? -h: E.nodeValue.length + h
                        }
                    };
                    return function() {
            ...
            selectRanges: function(a) {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    a: {
                        var n, w;
                        if (1 == a.length && !(w = a[0]).collapsed && (k = w.getEnclosedNode()) && k.type == CKEDITOR.NODE_ELEMENT && (w = w.clone(), w.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (n = w.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT && (k = n), "false" == k.getAttribute("contenteditable"))) break a;
                        k = void 0
                    }
                    if (k) this.fake(k);
                    else {
                        if (q) {
                            ...
                            if (k.startContainer.type == CKEDITOR.NODE_ELEMENT && k.startContainer.getName() in b || k.endContainer.type == CKEDITOR.NODE_ELEMENT && k.endContainer.getName() in b) k.shrink(CKEDITOR.NODE_ELEMENT, !0),
                            a = k.collapsed;
                            x = k.createBookmark();
                            b = x.startNode;
                            a || (f = x.endNode);
                            ...
                            f ? (n = k.document.$.body.createTextRange(), n.moveToElementText(f.$), x.setEndPoint("EndToEnd", n), x.moveEnd("character", -1)) : (u = b.getNext(w), t = b.hasAscendant("pre"), u = !(u && u.getText && u.getText().match(n)) && (t || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), t = k.document.createElement("span"), t.setHtml("\x26#65279;"), t.insertBefore(b), u && k.document.createText("﻿").insertBefore(b));
                            k.setStartBefore(b);
                            b.remove();
                            ...
                            for (x = 0; x < a.length; x++) {
                                ...
                                k.collapsed && CKEDITOR.env.webkit && e(k) && (n = g(this.root), k.insertNode(n), (u = n.getNext()) && !n.getPrevious() && u.type == CKEDITOR.NODE_ELEMENT && "br" == u.getName() ? (l(this.root), k.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START)) : k.moveToPosition(n, CKEDITOR.POSITION_AFTER_END));
                                t.setStart(k.startContainer.$, k.startOffset);
                                try {
                                    t.setEnd(k.endContainer.$, k.endOffset)
                                } catch(D) {
                                    if (0 <= D.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) k.collapse(1),
                                    t.setEnd(k.endContainer.$, k.endOffset);
                                    else throw D;
                                }
                                f.addRange(t)
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
        ...
        function b(c) {
            ...
            c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    k = !1;
                    if (r.equals(w)) r = null,
                    k = !0;
                    else {
                        var t = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                        x = t && "false" == r.getAttribute("contentEditable"),
                        y = t && r.getAttribute("data-nostyle");
                        if (t && r.data("cke-bookmark")) {
                            r = r.getNextSourceNode(!0);
                            continue
                        }
                        if (x && m && CKEDITOR.dtd.$block[t]) for (var A = r,
                        z = e(A), C = void 0, G = z.length, H = 0, A = G && new CKEDITOR.dom.range(A.getDocument()); H < G; ++H) {
                            var C = z[H],
                            R = CKEDITOR.filter.instances[C.data("cke-filter")];
                            if (R ? R.check(this) : 1) A.selectNodeContents(C),
                            b.call(this, A)
                        }
                        z = t ? !n[t] || y ? 0 : x && !m ? 0 : d(r, w, h, M) : 1;
                        if (z) if (C = r.getParent(), z = h, G = g, H = l, !C || !(C.getDtd() || CKEDITOR.dtd.span)[G] && !H || z.parentRule && !z.parentRule(C)) k = !0;
                        else {
                            if (u || t && CKEDITOR.dtd.$removeEmpty[t] && (r.getPosition(w) | M) != M || (u = c.clone(), u.setStartBefore(r)), t = r.type, t == CKEDITOR.NODE_TEXT || x || t == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var t = r,
                                Y; (k = !t.getNext(K)) && (Y = t.getParent(), n[Y.getName()]) && d(Y, q, h, Q);) t = Y;
                                u.setEndAfter(t)
                            }
                        } else k = !0;
                    ...
                    if (k && u && !u.collapsed) {
                        for (var k = F(this, f), x = k.hasAttributes(), y = u.getCommonAncestor(), t = {},
                        z = {},
                        C = {},
                        G = {},
                        U, P, da; k && y;) {
                            if (y.getName() == g) {
                                for (U in h.attributes) ! G[U] && (da = y.getAttribute(P)) && (k.getAttribute(U) == da ? z[U] = 1 : G[U] = 1);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? u.call(this, e) : q(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())),
                e = f
            }
            a.moveToBookmark(c);
        ...
        function g(a) {
            var b = a.getEnclosedNode() || a.getCommonAncestor(!1, !0); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && t(a, this)
        }
        function l(a) {
        ...
        function k(a) {
            ...
            f; d = c.getNextParagraph();) ! d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = F(this, e, d), w(d, f));
            a.moveToBookmark(b)
        }
        function n(a) {
            ...
            for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null: a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div")) && d.copyAttributes(e), w(d, e)) : u.call(this, d));
            a.moveToBookmark(b)
        }
        function w(a, b) {
            var c = !b;
        ...
        function y(a, b) {
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) {
                ...
                d = a.getNext(R); ! c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({
                    br: 1
        ...
        function z(a, b) {
            for (var c in a) a[c] = a[c].replace(H,
            function(a, c) {
                return b[c]
            })
        }
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            if (n.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (n.equals(e)) break;
                if (!l && (w = n.getName(), "true" == n.getAttribute("contenteditable") ? l = n: !g && d[w] && (g = n), a[w])) {
                    if (w = !g && "div" == w) {
                        a: {
                            w = n.getChildren();
                            for (var f = 0,
        ...
        var d = {
                ...
                return {
                    getNextRange: function(l) {
                        ...
                        if (k && 1 < a.length) {
                            ...
                            for (k.moveToBookmark(d.shift()); w--;) n = a[++g],
            ...
            createBookmarks: function(b) {
                for (var c = [], d, g = 0; g < this.length; g++) {
                    ...
                    for (var l = g + 1; l < this.length; l++) this[l] = a(d, this[l]),
                    this[l] = a(d, this[l], !0)
                }
                return c
            },
        ...
        function y(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.safari && m.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text")); (k = m.getParent().isReadOnly()) ? (m.setOpacity(0), m.setAttribute("contenteditable", !0)) : m.setStyle("ltr" == b.config.contentsLangDirection ? "left": "right", "-1000px");
