	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"fileExt":{
					"regex":/[.](jpg|JPG|Jpg|JpG|JPg|jPg|jPG|jpG)$/,
					"alertText":"* 只支持jpg格式文件上传"
				},
				"invalidChar":{
					"regex":/[0-9a-zA-Z\u4e00-\u9fa5()（）]$/,
					"alertText":"输入的文字含有非法字符"
				},
				"validSelect":{
					"alertText":"请至少选择一项"
				},
				'numberAndInteger':{
                    'regex':/^[0-9]+\.?[0-9]{0,2}$/,
                    'alertText':'请输入整数或小数(最多两位小数)'                
                },
                "fileName":{
					"regex":/^[a-zA-Z-]+[.]html$/,
					"alertText":"不是有效的文件名格式(例如：abc-abc.html或者abcAbc.html)"
				},
